...
// Inlined from the former assets/svg/SampleWaveformFilled.svg so the app does not
// need vite-plugin-solid-svg for a single icon.
export default function SampleWaveformFilled(props: JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="45 34.7 360 277.6" {...props}>
